...
export const trustPoints = [
  {
    ...
    description: "Опираемся на методики федераций и практику тренеров.",
  },
  {
    title: "Понятно новичкам",
    description: "Без лишнего жаргона или с пояснениями по ходу текста.",
  },
  {
    title: "Полезно тренерам",
    description: "Идеи для планов, разборы типовых ситуаций в зале.",
  },
  {
    title: "Обновляется регулярно",
    description: "Новые материалы и актуализация гайдов по сезону.",
  },
];
